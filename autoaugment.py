...
class CIFAR10Policy(object):
    ...
    def __init__(self, fillcolor_img=(0, 0, 0), fillcolor_mask=0, task="classification"):
        ...
        self.policies = [
            policy(0.1, "invert", 7, 0.2, "contrast", 6, fillcolor),
            policy(0.7, "rotate", 2, 0.3, "translateX", 9, fillcolor),
            policy(0.8, "sharpness", 1, 0.9, "sharpness", 3, fillcolor),
            policy(0.5, "shearY", 8, 0.7, "translateY", 9, fillcolor),
            policy(0.5, "autocontrast", 8, 0.9, "equalize", 2, fillcolor),

            policy(0.2, "shearY", 7, 0.3, "posterize", 7, fillcolor),
            policy(0.4, "color", 3, 0.6, "brightness", 7, fillcolor),
            policy(0.3, "sharpness", 9, 0.7, "brightness", 9, fillcolor),
            policy(0.6, "equalize", 5, 0.5, "equalize", 1, fillcolor),
            policy(0.6, "contrast", 7, 0.6, "sharpness", 5, fillcolor),

            policy(0.7, "color", 7, 0.5, "translateX", 8, fillcolor),
            policy(0.3, "equalize", 7, 0.4, "autocontrast", 8, fillcolor),
            policy(0.4, "translateY", 3, 0.2, "sharpness", 6, fillcolor),
            policy(0.9, "brightness", 6, 0.2, "color", 8, fillcolor),
            policy(0.5, "solarize", 2, 0.0, "invert", 3, fillcolor),

            policy(0.2, "equalize", 0, 0.6, "autocontrast", 0, fillcolor),
            policy(0.2, "equalize", 8, 0.6, "equalize", 4, fillcolor),
            policy(0.9, "color", 9, 0.6, "equalize", 6, fillcolor),
            policy(0.8, "autocontrast", 4, 0.2, "solarize", 8, fillcolor),
            policy(0.1, "brightness", 3, 0.7, "color", 0, fillcolor),

            policy(0.4, "solarize", 5, 0.9, "autocontrast", 3, fillcolor),
            policy(0.9, "translateY", 9, 0.7, "translateY", 9, fillcolor),
            policy(0.9, "autocontrast", 2, 0.8, "solarize", 3, fillcolor),
            policy(0.8, "equalize", 8, 0.1, "invert", 3, fillcolor),
            policy(0.7, "translateY", 9, 0.9, "autocontrast", 1, fillcolor)
        ]
...
class SVHNPolicy(object):
    ...
    def __init__(self, fillcolor_img=(0, 0, 0), fillcolor_mask=0, task="classification"):
        ...
        self.policies = [
            policy(0.9, "shearX", 4, 0.2, "invert", 3, fillcolor),
            policy(0.9, "shearY", 8, 0.7, "invert", 5, fillcolor),
            policy(0.6, "equalize", 5, 0.6, "solarize", 6, fillcolor),
            policy(0.9, "invert", 3, 0.6, "equalize", 3, fillcolor),
            policy(0.6, "equalize", 1, 0.9, "rotate", 3, fillcolor),

            policy(0.9, "shearX", 4, 0.8, "autocontrast", 3, fillcolor),
            policy(0.9, "shearY", 8, 0.4, "invert", 5, fillcolor),
            policy(0.9, "shearY", 5, 0.2, "solarize", 6, fillcolor),
            policy(0.9, "invert", 6, 0.8, "autocontrast", 1, fillcolor),
            policy(0.6, "equalize", 3, 0.9, "rotate", 3, fillcolor),

            policy(0.9, "shearX", 4, 0.3, "solarize", 3, fillcolor),
            policy(0.8, "shearY", 8, 0.7, "invert", 4, fillcolor),
            policy(0.9, "equalize", 5, 0.6, "translateY", 6, fillcolor),
            policy(0.9, "invert", 4, 0.6, "equalize", 7, fillcolor),
            policy(0.3, "contrast", 3, 0.8, "rotate", 4, fillcolor),

            policy(0.8, "invert", 5, 0.0, "translateY", 2, fillcolor),
            policy(0.7, "shearY", 6, 0.4, "solarize", 8, fillcolor),
            policy(0.6, "invert", 4, 0.8, "rotate", 4, fillcolor),
            policy(0.3, "shearY", 7, 0.9, "translateX", 3, fillcolor),
            policy(0.1, "shearX", 6, 0.6, "invert", 5, fillcolor),

            policy(0.7, "solarize", 2, 0.6, "translateY", 7, fillcolor),
            policy(0.8, "shearY", 4, 0.8, "invert", 8, fillcolor),
            policy(0.7, "shearX", 9, 0.8, "translateY", 3, fillcolor),
            policy(0.8, "shearY", 5, 0.7, "autocontrast", 3, fillcolor),
            policy(0.7, "shearX", 2, 0.1, "invert", 5, fillcolor)
        ]
