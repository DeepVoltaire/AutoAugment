...
__Update 11.07.2018:__ Will publish a blog post in the next couple of days about AutoAugment and some experiments where I did double transfer learning: Fine-tuning ImageNet weights while using AutoAugment ImageNet augmentations. Code updates: The fill color after applying translations, rotations and shearing can now be specified with e.g. "policy = ImageNetPolicy(fillcolor=(0, 0, 0))". Current functionality seems to work well. Will update as soon I know more details from the authors.
